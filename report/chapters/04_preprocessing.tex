...
The video is transcoded into four resolution variants. Each variant is segmented into 10-second TS (MPEG Transport Stream) chunks. A master M3U8 playlist references all variant playlists, enabling the frontend player to automatically select the optimal quality based on available bandwidth.
