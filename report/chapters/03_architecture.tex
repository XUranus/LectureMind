...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[right of=t6, xshift=0.5cm, font=\footnotesize, align=left] {T6 reads T1\\output from DB};
    \end{tikzpicture}
...
\begin{itemize}
    ...
    \item \textbf{Thumbnail:} Screenshots extracted at slide transition points; stores both \texttt{image} (200px, web display) and \texttt{image\_high\_res} (1920px, OCR input)
    \item \textbf{SlideOCR:} Text content extracted from high-resolution slide thumbnails via multimodal LLM
